#python3 analysisExcludingError.py baseD31 D31Static D31Inc 50 0.01 256 10 D31ds
#python3 analysisExcludingError.py baseshuttle shuttleStatic shuttleInc 50 0.01 256 10 shuttleds
#python3 analysisExcludingError.py basekddcup1m kddcup1mStatic kddcup1mInc 50 0.01 256 10 kddcup1mds
import sys, os
...
#incremetnal run for udated dataset
...
#compute avg time and avg space consumption and avg standard deviation in pairwise mass value for incremetnal run
	...
	#print ("Time =",timeSum/numOfVersions,"	Space =", spaceSum/numOfVersions,"	VirtualSpace=", vSpaceSum/numOfVersions,"	TotalNodes=",int(totalNodes/numOfVersions),"	UnchangedNodes=",int(unchangedNodes/numOfVersions),"	%of Unchanged Nodes=",100*(int(unchangedNodes/numOfVersions))/(int(totalNodes/numOfVersions)),"	  Standard deviation =", accuSum/numOfVersions)
